package com.common.common_base.utils.util;
...
public final class FragmentUtils{
    ...
    private static void setupFragment(@IdRes int id, Context context, String fragmentName, Bundle args){
        if(!(context instanceof FragmentActivity)){
            return;
        }
        android.app.Fragment fragment = android.app.Fragment.instantiate(context, fragmentName, args);
