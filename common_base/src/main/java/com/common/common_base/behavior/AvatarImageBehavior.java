package com.common.common_base.behavior;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private float mCustomFinalYPosition;//none
    private float mCustomStartXPosition;//none
    private float mCustomStartToolbarPosition;//none
    private float mCustomStartHeight;//none
    private float mCustomFinalHeight;//结束最小半径
