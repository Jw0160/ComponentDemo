package com.common.common_base.widget.badge;
...
public class BadgeFactory {
    ...
    public static BadgeView createCircle(Context context) {
        return new BadgeView(context).setWidthAndHeight(25, 25).setTextSize(12).setBadgeGravity(Gravity.RIGHT | Gravity.TOP).setShape(BadgeView.SHAPE_CIRCLE);
    }
