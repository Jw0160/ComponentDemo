...
public class ShapeLoadingView extends View {
    ...
    public ShapeLoadingView(Context mContext, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        switch (mShape) {
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(ContextCompat.getColor(this.getContext(),R.color.circle));
                    Path path = new Path();
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(ContextCompat.getColor(this.getContext(),R.color.rect));
