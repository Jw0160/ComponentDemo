package com.common.common_base.widget.loadlayout;
...
public class LoadingLayout extends FrameLayout{
    ...
    public LoadingLayout(Context context, AttributeSet attrs){
        ...
        pageBackground = a.getColor(R.styleable.LoadingLayout_pageBackground, Utils.getColor(mContext, R.color.Grey10));
        a.recycle();
    }
    ...
    public static class Config{
        ...
        int tipTextColor = R.color.Grey50;
        int buttonTextColor = R.color.Grey50;
        int buttonWidth = -1;
        int buttonHeight = -1;
        int loadingLayoutId = R.layout.widget_loading_page;
        View loadingView = null;
        int backgroundColor = R.color.Grey10;
