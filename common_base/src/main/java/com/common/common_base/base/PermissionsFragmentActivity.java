...
public abstract class PermissionsFragmentActivity extends BaseFragmentActivity implements PermissionListener, RationaleListener{
    ...
    public void onFailed(int requestCode, @NonNull List<String> deniedPermissions){
        ...
        if(AndPermission.hasAlwaysDeniedPermission(PermissionsFragmentActivity.this, deniedPermissions)){
            // 第一种：用默认的提示语。
            AndPermission.defaultSettingDialog(PermissionsFragmentActivity.this, requestCode).show();
            // 第二种：用自定义的提示语。
    ...
    public void showRequestPermissionRationale(int requestCode, final Rationale rationale){
        ...
        AndPermission.rationaleDialog(PermissionsFragmentActivity.this, rationale)
                //自定义内容
                //                .setTitle("title")
                //                .setMessage("message")
