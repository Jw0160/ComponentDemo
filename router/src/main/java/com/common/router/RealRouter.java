...
import com.common.router.matcher.AbsImplicitMatcher;
import com.common.router.matcher.AbsMatcher;
import com.common.router.util.RLog;
...
class RealRouter extends AbsRouter{
    ...
    private Intent finalizeIntent(Context context, AbsMatcher matcher, @Nullable Class<?> target){
        ...
        Log.e("RealRouter", "intent:" + intent);
    ...
    private RouterHandler getRouterHandler(Context context){
        if(mRouteRequest.getUri() == null){
            callback(RouteResult.FAILED, "uri == null.");
            return null;
        }
    ...
    public void go(Context context){
        RouterHandler lRouterHandler = getRouterHandler(context);
        if(lRouterHandler != null){
            KLog.e("routeHandler class = " + lRouterHandler.getClass().getName());
            if(context == null){
