...
public class URLParserPre {
    ...
    public URLParserPre(String url) throws MalformedURLException {
        this(url, "utf-8");
    }
     ...
     */
    public URLParserPre(final String url, final String charset) throws MalformedURLException {
        checkNull(url, "url");
        orignUrl = url;
...
//		String url = "ftp://www.test.com/aaa/bbb;xxx=xxx?eee=111&fff=222&fff=333";
        ...
        URLParserPre parser = new URLParserPre(url);
