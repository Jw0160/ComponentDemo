...
/**
 * This class represents a URLPre for an internet resource. It is not to be
 * confused with a URI. I wrote this class to make a URLPre class for Java that is
 * more OO than the traditional java.net.URLPre. It is most useful for modifying
 * URLs for a web application.
 * 
 * @author <a href="https://github.com/juliuss">julius schorzman</a>
 */
public class URLPre implements Iterable<URLPre.Parameter> {

  /**
   * Represents a URLPre parameter. Names and values are automatically encoded on
  ...
  /**
   * Returns a URLPre for the provided String, or null if the URLPre provided is
   * invalid.
   * 
   * @param url
   *          The external form of a URLPre.
   * @return A URLPre object for the provided String, or null if the URLPre provided
   *         is invalid.
   */
  public static URLPre get(String url) {
    try {
      return new URLPre(url);
    } catch (Exception e) {
      return null;
    }
  }
  ...
  /**
   * Returns a URLPre for the provided String, or the provided default URLPre if the
   * URLPre provided is invalid.
   * 
   * @param url
   *          The external form of a URLPre.
   * @param defaul
   *          The URLPre that should be returned in cases where the primary url is
   *          invalid.
   * @return A URLPre object for the provided String, or null if the URLPre provided
   *         is invalid.
   */
  public static URLPre get(String url, URLPre defaul) {
    try {
      return new URLPre(url);
    } catch (Exception e) {
      return defaul;
  ...
  /**
   * Tests if the provided URLPre is valid.
   * 
   * @param url
   *          The URLPre to test.
   * @return true if the URLPre can be instantiated, false otherwise.
   */
  ...
  /**
   * Creates a URLPre given a provided URLPre. Reference URLPre(String url) for more
   * info.
   */
  public URLPre(URI uri) {
    this(uri.toString());
  }
   ...
   * info.
   */
  public URLPre(java.net.URL url) {
    this(url.toExternalForm());
  }

  /**
   * Creates a URLPre given a provided string. Must be a valid URLPre (according to
   ...
   * IllegalArgumentException for an empty or invalid URLPre), so the expectation
   ...
   * 
   * <pre>
   * {@code URLPre.get("an invalid url!")}
   * </pre>
   * 
   * which will not throw an exception and instead return null, or:
   * 
   * <pre>
   * {@code URLPre.get("an invalid url!","http://www.example.com/a-default-url.html")}
   * </pre>
   * 
   ...
   * 
   * @param url
   *          The external form of the URLPre. Ex: http://www.google.com If this
   ...
   */
  public URLPre(String url) {

    // test the input
    if (url == null)
      throw new NullPointerException("URLPre cannot be null");
    if (url.isEmpty())
      throw new IllegalArgumentException("URLPre cannot be empty");
  ...
  /**
   * Adds a parameter to the URLPre with the provided name and value. Reference
   * addParameter(String name, String value) for more info.
   */
  public URLPre addParameter(String name, int value) {
    addParameter(name, value + "");
    return this;
  }

  /**
   * Returns a copy of this URLPre.
   */
  public URLPre clone() {
    return new URLPre(this.toString());
  }

  /**
   * Adds a parameter to the URLPre with the provided name and value. Example:
   * 
   * <pre>
   * {@code URLPre ( "http://www.shopobot.com/search" ).addParameter( "query" ,
   ...
   * 
   * <pre>
   * {@code URLPre( "http://www.shopobot.com/search?query=ipod" ).addParameter(
   * "query" , "ipad" ).equals(
   ...
   */
  public URLPre addParameter(String name, String value) {
   ...
   */
  private URLPre addParameterNoEncode(String name, String value) {
    if (name == null || name.isEmpty()) {
      return this;
    }
  ...
  /**
   * Decrements by 1 the integer value of the parameter in the URLPre that matches
   * the provided name. If the URLPre contains multiple parameters, the first
   ...
   */
  public URLPre decrementParameter(String name) {
    if (name == null || name.isEmpty()) {
      return this;
    }
  ...
  @Override
  /**
   * Compares this object with a similar object, String, java.net.URLPre, java.netURI.  Returns true if the external form of the URLPre is identical.
   */
  ...
  /**
   * Helper method that URLPre decodes a value.
   */
  private String fragmentDecode(String value) {
    try {
      return FragmentEncoderPre.decode(value, URLPre.ENCODING);
    } catch (UnsupportedEncodingException e) {
      throw new IllegalArgumentException(URLPre.ENCODING + URLPre.ENCODING_ERROR, e);
    }
  }

  /**
   * Helper method that URLPre encodes a value.
   */
  private String fragmentEncode(String value) {
    try {
      return FragmentEncoderPre.encode(value, URLPre.ENCODING);
    } catch (UnsupportedEncodingException e) {
      throw new IllegalArgumentException(URLPre.ENCODING + URLPre.ENCODING_ERROR, e);
    }
  }
  ...
  /**
   * Returns the fragment portion of this URLPre. For example, "fragment" from:
  ...
  /**
   * Returns the host portion of this URLPre. For example, "www.google.com" from:
   * http://www.google.com/?name=value#fragment
   * 
   * For reference the get methods are named as:
   * protocol://username:password@host:port/path?query#fragment
  ...
  /**
   * Gets the integer value of the parameter in the URLPre that matches the
   * provided name. If the URLPre contains multiple parameters, the first
  ...
  /**
   * Gets the value of the parameter in the URLPre that matches the provided name.
   * If the URLPre contains multiple parameters, the first encountered will be
   * returned. In cases where the URLPre contains multiple parameters with the same
  ...
  /**
   * Gets the values of the parameters in the URLPre that matche the provided name.
   * If the URLPre contains unique parameter names, use getPatameter instead. If no
  ...
  /**
   * Returns the password portion of this URLPre. For example, "pass" from:
  ...
  /**
   * Returns the path portion of this URLPre. For example,
  ...
  /**
   * Returns the path of this URLPre split by /. For example,
  ...
  /**
   * Returns the port of this URLPre. If no port is present in the URLPre, the default
  ...
  /**
   * Returns the protocol portion of this URLPre. For example, the enum for http is
  ...
  /**
   * Returns the user portion of this URLPre. For example, "user" from:
   * ftp://user:pass@ftp.example.com/?name=value#fragment
   * 
   * For reference the get methods are named as:
   * protocol://username:password@host:port/path?query#fragment
  ...
  /**
   * Returns a new URLPre given a relative path.
   * 
   * For example, if this URLPre object represents "http://example.com" then
   * calling this method with "/a.html" will return "http://example.com/a.html"
   * 
   * Warning: be careful not to pass a non-relative url.
   * 
   * @param relativePath
   * @return A URLPre object representing the relative path.
   */
  public URLPre resolveRelative(String relativePath) {
    relativePath = relativePath.trim();
    URI baseURI = this.toJavaURI();
    URI resultURI = baseURI.resolve(relativePath);
    URLPre urlPre = new URLPre(resultURI.toString());
    return urlPre;
  }

  /**
   * Increments by 1 the integer value of the parameter in the URLPre that matches
   * the provided name. If the URLPre contains multiple parameters, the first
   ...
   */
  public URLPre incrementParameter(String name) {
    for (Parameter p : parameters) {
      if (p.getName().equals(name)) {
        try {
          int i = Integer.parseInt(p.getValue());
  ...
  /**
   * Returns an Iterator for all parameters represented in this URLPre. For
  ...
  /**
   * Removes the fragment from this URLPre. If no fragment exists, no change will
   * occur.
   * 
   * @return This object for chaining.
   */
  public URLPre removeFragment() {
    this.fragment = "";
    return this;
  }

  /**
   * Removes all parameters with the given name from the URLPre.
   * 
   * The name of the parameter(s) to remove. Null or empty string will
   *          cause no changes to occur.
   * @return This object for chaining.
   */
  public URLPre removeParameter(String... name) {
    if (name == null) {
      return this;
    }
    for (String n : name) {
  ...
  /**
   * Sets the fragment for this URLPre. Any existing fragment will be overwritten.
   * A null or empty parameter will remove the fragment completely.
   * 
   * @param fragment
   * @return This object for chaining.
   */
  public URLPre setFragment(String fragment) {
   ...
   * @return This object for chaining.
   */
  public URLPre setHost(String host) {
   ...
   * @return This object for chaining.
   */
  public URLPre setParameter(String name, int value) {
    setParameter(name, value + "");
    return this;
  }

  /**
   * Sets the value of this parameter in the URLPre. If no parameter exists with
   * the provided name, it will be added. Example:
   * 
   * <pre>
   * {@code URLPre( "http://www.shopobot.com/" ).setParameter( "page" , 1
   ...
   * 
   * <pre>
   * {@code URLPre( "http://www.shopobot.com/?page=1" ).setParameter( "page" , 2
   ...
   * 
   * <pre>
   * {@code URLPre( "http://www.shopobot.com/?x=1&x=2" ).setParameter( "x" , 3
   * ).equals( "http://www.shopobot.com/?x=3" );}
   * </pre>
   * 
   * @return This object for chaining.
   */
  public URLPre setParameter(String name, String value) {
    removeParameter(name);
    addParameter(name, value);
    return this;
  }
   ...
   * @return This object for chaining.
   */
  public URLPre setPassword(String password) {
   ...
   * @return This object for chaining.
   */
  public URLPre setPath(String path) {
    if (path.startsWith("/")) {
      this.path = path;
    } else {
      this.path = "/" + path;
   ...
   * @throws IllegalArgumentException
   */
  public URLPre setPort(int port) throws IllegalArgumentException {
   ...
   *           thrown.
   */
  public URLPre setProtocol(String protocol) throws IllegalArgumentException {
   ...
   * @return This object for chaining.
   */
  public URLPre setUsername(String username) {
  ...
  /**
   * Helper method that just returns the query string of this URLPre, including a
  ...
  /**
   * Helper method that just returns the fragment string of this URLPre, including
  ...
  public String toStringRelative(URLPre relativeTo) {
  ...
  private String urlDecode(String value) {
    try {
      return URLDecoder.decode(value, URLPre.ENCODING);
    } catch (UnsupportedEncodingException e) {
      throw new IllegalArgumentException(URLPre.ENCODING + URLPre.ENCODING_ERROR, e);
    }
  }
  ...
  private String urlEncode(String value) {
    try {
      return URLEncoder.encode(value, URLPre.ENCODING);
    } catch (UnsupportedEncodingException e) {
      throw new IllegalArgumentException(URLPre.ENCODING + URLPre.ENCODING_ERROR, e);
    }
  }
   ...
   * 
   * @param queryString
   *          Either a whole URLPre ("http://www.shopobot.com/?query=test") or just
   *          a query string ("?query=test"). If null or "" is pased, this
   *          method silently returns without changing anything.
   */
  private URLPre parseQueryString(String queryString) {
  ...
  /**
   * Returns an instance of java.net.URLPre that represents this URLPre. If the URLPre is
  ...
  /**
   * Returns "http://www.google.com:80" for the URLPre
  ...
  /**
   * Tests if this URLPre object matches the authority of the provided String (or
   * URLPre). Example: new
   * URLPre("www.subdomain.example.com").matchesAuthority("com"); //true new
   * URLPre("www.subdomain.example.com").matchesAuthority("example.com"); //true
   * new
   * URLPre("www.subdomain.example.com").matchesAuthority("subdomain.example.com");
   * //true new URLPre("www.subdomain.example.com").matchesAuthority(
   ...
   * 
   * @param string
   *          A string reresenting the authority to check against this urlPre.
   * @return true if the authority matches, false in all other cases (including
   *         if a null or empty parameter is passed).
   */
  public boolean matchesAuthority(URLPre urlPre) {
    return matchesAuthority(urlPre.getHost());
  }

  /**
   * Checks if any of the authorities provided match this URLPre.  If one matches, true is returned.
   */
  public boolean matchesAuthority(String... authority) {
   ...
   * URLPre("shopobot.com").getAuthoritySize(2); new
   * URLPre("en.shopobot.com").getAuthoritySize(3); new
   * URLPre("www.en.shopobot.com").getAuthoritySize(4);
   */
